...
class FeedCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        likesLable.anchor(top: likeButton.bottomAnchor, left: leftAnchor,
                          paddingTop: -4, paddingLeft: 8)

        addSubview(captionLabel)
        captionLabel.anchor(top: likesLable.bottomAnchor, left: leftAnchor, paddingTop: 8, paddingLeft: 8)
